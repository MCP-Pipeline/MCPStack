...
class HelloWorldCLI(BaseToolCLI):
    ...
    def configure(
        cls,
        prefix: Annotated[Optional[str], typer.Option("--prefix", "-p", help="Greeting prefix emoji/text.")] = None,
        languages: Annotated[Optional[str], typer.Option("--languages", "-l", help="Comma list: french,italian,german,chinese")] = None,
    ...
    def status(cls, verbose: bool = False) -> None:
        ...
        console.print(Panel.fit(msg, title="[bold green]hello_world status[/bold green]"))